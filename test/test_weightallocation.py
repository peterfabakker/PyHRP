...
def test_get_all_leafs():
    ...
    cluster_num = 5
    clustering_allocation = ClusteringAllocation(quasi_diag_cov=None, tickers=None, link_matrix=link_matrix, strategy='ivp')
...
def test_ERC_min_function():
    ...
    clustering_allocation = ClusteringAllocation(quasi_diag_cov=None, tickers=None, link_matrix=None, strategy='ivp')
...
def test_jac_ERC_min_function():
    ...
    clustering_allocation = ClusteringAllocation(quasi_diag_cov=None, tickers=None, link_matrix=None, strategy='erc')
